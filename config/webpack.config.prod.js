...
// style files regexes
const cssRegex = /\.css$/;
// 添加 匹配use.css或者useable.css结尾的文件 /\.use(able)?\.css$/
const useable = /\.use(able)?\.css$/;  //现在这种是所有的都是分包加载
const cssModuleRegex = /\.module\.css$|\.use(able)?\.css$/; // 这里也需要修改 需要让普通名称的css文件的loader覆盖 \.use(able)?\.css$
...
module.exports = {
    ...
    output: {
        ...
        //将相应的css和js文件写入到html文件中的路径开头 "."+      +"zhongshan/"
